/**
 * note HTML → markdown 변환기. (note_mcp/src/note-to-md.ts 포팅, 의존성 없음)
 * note 본문은 제약된 HTML 서브셋: 블록마다 name=id=UUID,
...
const elements = (nodes) => nodes.filter(isEl);
...
export function noteHtmlToMd(html) {
